...
export const Authority = {
  ...
  TENANT_INTEGRATIONS_READ: "TENANT_INTEGRATIONS_READ",
  TENANT_INTEGRATIONS_MANAGE: "TENANT_INTEGRATIONS_MANAGE",
  UI_TENANT_INTEGRATIONS_VIEW: "UI_TENANT_INTEGRATIONS_VIEW",
  TENANT_BIDS_READ: "TENANT_BIDS_READ",
  TENANT_BIDS_CREATE: "TENANT_BIDS_CREATE",
  TENANT_BIDS_UPDATE: "TENANT_BIDS_UPDATE",
  TENANT_BIDS_PROCESS_EMAIL: "TENANT_BIDS_PROCESS_EMAIL",
  TENANT_BIDS_REVIEW_UPDATES: "TENANT_BIDS_REVIEW_UPDATES",
  TENANT_BIDS_VIEW_PARSING: "TENANT_BIDS_VIEW_PARSING",
  TENANT_BIDS_VIEW_AUDIT: "TENANT_BIDS_VIEW_AUDIT",
  UI_TENANT_BIDS_VIEW: "UI_TENANT_BIDS_VIEW",
} as const;
